...
public class SorensenTests {
    ...
    public void identity() {
        ...
        Assert.assertEquals(1.0, new Sorensen<>(a, b).value(), 1e-8);
    }
    ...
    public void zero() {
        ...
        Assert.assertEquals(0.0, new Sorensen<>(a, b).value(), 1e-8);
    }
    ...
    public void normal() {
        ...
        Assert.assertEquals(1.0 / 3.0, new Sorensen<>(a, b).value(), 1e-8);
    }
    ...
    public void commutativity() {
        ...
        Assert.assertEquals(new Sorensen<>(b, a).value(), new Sorensen<>(a, b).value(), 1e-8);
        Assert.assertEquals(1.0 / 2.5, new Sorensen<>(a, b).value(), 1e-8);
    }
}
