...
public class MutualInformationTests {
    ...
    public void identity() {
        ...
        Assert.assertEquals(1.0, new MutualInformation<>(a, b, world).value(), 1e-8);
    }
    ...
    public void commutativity() {
        ...
        Assert.assertEquals(new MutualInformation<>(b, a, world).value(), new MutualInformation<>(a, b, world).value(), 1e-8);
    }
}
